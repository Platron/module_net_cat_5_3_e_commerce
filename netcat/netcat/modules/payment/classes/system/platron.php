...
class nc_payment_system_platron extends nc_payment_system {
    ...
    public function execute_payment_request(nc_payment_invoice $invoice) {
		...
		$arrFields = array(
			...
			'pg_check_url'		=> $this->get_callback_script_url() . "&type=check&invoice_id=".$invoice->get_id(),
			'pg_result_url'		=> $this->get_callback_script_url() . "&type=result&invoice_id=".$invoice->get_id(),
