...
class nc_payment_system_platron extends nc_payment_system {
    ...
    public function execute_payment_request(nc_payment_invoice $invoice) {
		...
		$arrFields = array(
			...
			'pg_check_url'		=> "https://www.".$_SERVER['HTTP_HOST']."/netcat/modules/payment/callback.php?paySystem=nc_payment_system_platron&type=check&invoice_id=".$invoice->get_id(),
			'pg_result_url'		=> "https://www.".$_SERVER['HTTP_HOST']."/netcat/modules/payment/callback.php?paySystem=nc_payment_system_platron&type=result&invoice_id=".$invoice->get_id(),
